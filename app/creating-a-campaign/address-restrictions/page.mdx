...
**Here’s a quick video about how to blacklist any address** (***similar steps can be taken to whitelist any address***):
...
<div className="mediaWrapper">
  <video
    ...
    loading="lazy"
  >
    <source src="/videos/blacklist-address-in-a-campaign.mp4" type="video/mp4" />
