---
title: Incentivize with Points
description: How to add points to your campaign.
---

## Incentivize with Points

Points campaigns allow you to reward liquidity providers with points. This
...
6. That’s it—no further action is needed. You can now go ahead to the **Campaign
   Preview**.

**Note**: **_You cannot use KPI or Range-based incentives with points._**
