...
[creating a campaign](/creating-a-campaign). Launching one with an attached Range-based Incentive is just as easy. For a quick refresher on KPIs, check out [Range Based Incentives](/rbi).
...
- **Current Price**: Shows you the current price for the tokens that are present in the selected pool. You can toggle relative price wrt to Token A / Token B by clicking on the token name.  
