...
import BaseParams from "../base-params.mdx";
...
Optional campaign status to filter for.
...
campaign creator if the ownership was transferred.
...
Optional campaign targeted dex.
