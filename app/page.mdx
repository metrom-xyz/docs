...
[Metrom](https://metrom.xyz) is a programmable incentives platform that DeFi protocols 
use to reward on-chain activities like providing liquidity, lending, holding tokens, 
while keeping distribution efficient.

Wherever your users are active, whether in a DEX pool, a lending market, or simply 
holding an asset, Metrom lets you design incentive structures around it, with 
flexibility and efficiency built in.

<div className="mediaWrapper">
  ![Metrom distribution](/images/metrom-campaign-types.png)
</div>
...
Rewards are then allocated in direct proportion to each participant's contribution, 
accurately reflecting the value they bring. The exact measure depends on the venue: 
for example, liquidity density (the size and concentration range of a position) for AMM pools, 
or net supply for lending markets.
